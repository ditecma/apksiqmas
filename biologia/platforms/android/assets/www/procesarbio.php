...
<body>
	<div class="contenedor">
			<div class="row">
				<div class="menu">
	  				<div class="menuizq col-xs-12 col-lg-12 imagenmenu" >
	  					...
	  					<div class="materia">
	  						Ciencias primer grado: Biología
	  					</div>
			...
			<div class="row">			
				<div class="ruta col-xs-12">Ciencias primer grado: Biología	/ Bloque II. La nutrición como base para la salud y la vida	/ Tema 3. Interacciones entre la ciencia y la tecnología en la satisfacción de las necesidades e intereses	/ Contenido: Valoración de la importancia de las iniciativas en el marco del Programa de las Naciones Unidas para el Medio Ambiente a favor del desarrollo sustentable. / Sesión 9</div>				
			</div>
...
<!-- 				<tr>
	...
	<div class="row">
			...
			<?php if($i>'0' && $i<'10'){ ?> 
			<div class="specificfeedback"><p> Parcialmente Correcta</p></div>
			<?php } else if($i=='0'){ ?>
			<div class="specificfeedback"><p> Incorrecta</p></div>
			<?php } else {?>
			<div class="specificfeedback"><p> Correcta</p></div>
			<?php }?>
			...
			<option <?php if($_POST['q14118:1_sub0']=='9'){echo "selected='selected'";}?>value="9">Conferencia Mundial sobre Desarrollo Sostenible Río + 10.</option>
			<option <?php if($_POST['q14118:1_sub0']=='10'){echo "selected='selected'";}?>value="10">1994</option>
			</select>
			...
			<option <?php if($_POST['q14118:1_sub1']=='9'){echo "selected='selected'";}?>value="9">Conferencia Mundial sobre Desarrollo Sostenible Río + 10.</option>
			<option <?php if($_POST['q14118:1_sub1']=='10'){echo "selected='selected'";}?>value="10">1994</option>
			</select>
			...
			<option <?php if($_POST['q14118:1_sub2']=='9'){echo "selected='selected'";}?>value="9">Conferencia Mundial sobre Desarrollo Sostenible Río + 10.</option>
			<option <?php if($_POST['q14118:1_sub2']=='10'){echo "selected='selected'";}?>value="10">1994</option>
			...
			<option <?php if($_POST['q14118:1_sub3']=='9'){echo "selected='selected'";}?>value="9">Conferencia Mundial sobre Desarrollo Sostenible Río + 10.</option>
			<option <?php if($_POST['q14118:1_sub3']=='10'){echo "selected='selected'";}?>value="10">1994</option>
			...
			<option <?php if($_POST['q14118:1_sub4']=='9'){echo "selected='selected'";}?>value="9">Conferencia Mundial sobre Desarrollo Sostenible Río + 10.</option>
			<option <?php if($_POST['q14118:1_sub4']=='10'){echo "selected='selected'";}?>value="10">1994</option>
			...
			<option <?php if($_POST['q14118:1_sub5']=='9'){echo "selected='selected'";}?>value="9">Conferencia Mundial sobre Desarrollo Sostenible Río + 10.</option>
			<option <?php if($_POST['q14118:1_sub5']=='10'){echo "selected='selected'";}?>value="10">1994</option>
			...
			<option <?php if($_POST['q14118:1_sub6']=='9'){echo "selected='selected'";}?>value="9">Conferencia Mundial sobre Desarrollo Sostenible Río + 10.</option>
			<option <?php if($_POST['q14118:1_sub6']=='10'){echo "selected='selected'";}?>value="10">1994</option>
			...
			<option <?php if($_POST['q14118:1_sub7']=='9'){echo "selected='selected'";}?>value="9">Conferencia Mundial sobre Desarrollo Sostenible Río + 10.</option>
			<option <?php if($_POST['q14118:1_sub7']=='10'){echo "selected='selected'";}?>value="10">1994</option>
			...
			<option <?php if($_POST['q14118:1_sub8']=='9'){echo "selected='selected'";}?>value="9">Conferencia Mundial sobre Desarrollo Sostenible Río + 10.</option>
			<option <?php if($_POST['q14118:1_sub8']=='10'){echo "selected='selected'";}?>value="10">1994</option>
			...
			<option <?php if($_POST['q14118:1_sub9']=='9'){echo "selected='selected'";}?>value="9">Conferencia Mundial sobre Desarrollo Sostenible Río + 10.</option>
			<option <?php if($_POST['q14118:1_sub9']=='10'){echo "selected='selected'";}?>value="10">1994</option>
